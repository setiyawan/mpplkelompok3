  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin">
		<h3 class="form-signin-heading text-center text-info">Password anda telah berhasil diganti</h3>
		<br><br>
		<p class="text-center text-info"> Silahkan login menggunakan password yang baru </p>
		<br><br>
		<p class="text-right"><a href="<?php echo base_url()?>index.php/profil/index/<?php echo $User[0]->NRP?>" class="btn btn-large btn-primary" type="submit" >Ok</a></p>
      </form>
