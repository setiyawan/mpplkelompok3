...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form class="form-signin" action="<?php echo base_url()?>index.php/login/daftar" method="POST">
        <h3 class="form-signin-heading">Masukkan Data Diri Anda</h3>
		<br>
    <?php if($flag==0) echo('<div class="alert alert-danger" role="alert">Maaf, Harap mengisi semua informasi</div>');?>    
