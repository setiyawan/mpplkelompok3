        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
			  ...
			  <li class="active"><a href="<?php echo base_url() ?>index.php/profil/index/<?php echo $Mahasiswa[0]->NRP?>">User</a></li>
			  <li><a href="<?php echo base_url()?>index.php/sistem/pengaduan/<?php echo $Mahasiswa[0]->NRP?>">List Pengaduan</a></li>
			...
			<ul class="nav pull-right">
				...
				<li>
					<div class="btn-group">
					<a href="<?php echo base_url() ?>index.php/profil/index/<?php echo $Mahasiswa[0]->NRP?>" class="btn btn-primary"><i class="icon-user icon-white"></i> &nbsp Admin</a>
					<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo base_url()?>index.php/login/ganti_pass/<?php echo $Mahasiswa[0]->NRP?>"><i class="icon-pencil"></i> Ganti Kata Sandi </a></li>
    ...
    <div class="container">
		...
		<div class="hero-unit">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span3">
						<img alt="User Pic" src="<?php echo base_url()?>image/man.jpg" class="img-circle" width="100px">
					</div>
					<div class="span9">
						...
						<a href="delete_result_admin.html" class="btn btn-large btn-primary" type="submit" >Delete</a></p>
