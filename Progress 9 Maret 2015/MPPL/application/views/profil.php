  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
        ...
        <div class="container">
          ...
          <div>
            <ul class="nav">
              ...
              <li><a href="<?php echo base_url()?>index.php/buku/daftarbuku/<?php echo $data['NRP']?>">Buku Saya</a></li>
              <li class="active"><a href="<?php echo base_url() ?>index.php/profil/index/<?php echo $data['NRP']?>">Profil</a></li>
      ...
      <ul class="nav pull-right">
        ...
        <li>
          <div class="btn-group">
          <a href="<?php echo base_url()?>index.php/profil/index/<?php echo $data['NRP']?>" class="btn btn-primary"><i class="icon-user icon-white"></i><?php echo $Mahasiswa[0]->NamaUser?></a>
          			...
          			<table class="table table-user-information">
            			<tbody>
                  		...
                  		<a href="<?php echo base_url()?>index.php/profil/editprofile/<?php echo $data['NRP']?>" class="btn btn-primary">Ubah Profil</a>
						          <a href="<?php echo base_url()?>index.php/profil/beranda/<?php echo $data['NRP']?>" class="btn btn-primary">Kembali ke beranda</a>
                  	</div>
        		</div>
      		</div>
    	</div>
