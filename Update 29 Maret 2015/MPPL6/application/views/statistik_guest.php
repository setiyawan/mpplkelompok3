        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">  
              ...
              <li class="active"><a href="<?php echo base_url()?>index.php/buku/statistik/guest?>">Statistik</a></li>
			...
			<li>
					<div class="btn-group">
					<a href="<?php echo base_url()?>index.php/profil/index/guest" class="btn btn-primary"><i class="icon-user icon-white"></i><?php echo "guest"?></a>
					<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo base_url()?>index.php/profil/editprofile/guest"><i class="icon-pencil"></i> Ubah Profil </a></li>
            <li><a href="<?php echo base_url()?>index.php/login/ganti_pass/guest"><i class="icon-cog"></i> Ganti Kata Sandi </a></li>
