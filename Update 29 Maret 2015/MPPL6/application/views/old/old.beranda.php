        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <?php if($User[0]->StatusUser == 1) {?>
              ...
              <li><a href="<?php echo base_url()?>index.php/profil/index/<?php echo $User[0]->NRP?>">Profile</a></li>
			  <li><a href="pengaduan.html">Pengaduan</a></li>
			  <li><a href="aboutus.html">About Us</a></li>
			  <?php }
			  else {?><li><a href="pengaduan.html">Pengaduan</a></li>
			  <li><a href="aboutus.html">About Us</a></li><?php }?>
            </ul>
			<div class="nav-collapse collapse">
