  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      ...
      <ul class="nav pull-right">
        <li>
          <div class="btn-group">
          <a href="<?php echo base_url()?>index.php/profil/index/<?php echo $User[0]->NRP?>" class="btn btn-primary"><i class="icon-user icon-white"></i><?php echo $Mahasiswa[0]->NamaUser?></a>
    ...
    <div class="container">
		<div class="page-header">
			<h1> <img src="<?php echo base_url() ?>/img/myprofil.png" class="img-rounded"> Profil <?php echo $data['Nama']?> </h1>
		</div>
                			...
                			<tr>
              				...
              				<tr>
                				...
                				<td></td>
						          ...
						          <a href="<?php echo base_url()?>index.php/profil/beranda/<?php echo $User[0]->NRP?>" class="btn btn-primary">Kembali ke beranda</a>
                  	</div>
        		</div>
      		</div>
    	</div>
