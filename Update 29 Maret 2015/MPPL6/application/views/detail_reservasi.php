...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="<?php echo base_url()?>index.php/buku/daftarbuku/<?php echo $User[0]->NRP?>">Buku Saya</a></li>
    ...
    <div class="page-header">
      <h1> <img src="<?php echo base_url(); ?>img/mybook.png" class="img-rounded"> Daftar Reservasi Buku </h1>
    </div>
    
    <div class="hero-unit">
	  <?php 
		echo "Judul Buku: ".$Buku[0]->Nama_Buku."\n\n";
	  ?>
