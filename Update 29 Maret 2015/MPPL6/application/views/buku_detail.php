  ...
  <body>
    ...
    <div class="container">
      ...
      <table class="table">
        <td>
          <div class="col-md-4">
            <img src="<?php echo base_url(); ?>image/buku/<?php echo $data['Gambar_Buku']?>" class="img-rounded">
          </div>
        </td>
        <td>
         <div class="col-md-8">
        ...
        <tr>
          ...
          <td>
            <?php if($data['Kategori']=="kom")
          echo "Komputer";
      else if($data['Kategori']=="ind")
          echo "Industri";
      else if($data['Kategori']=="sci")
          echo "Science";
      else if($data['Kategori']=="sip")
          echo "Sipil";
      else if($data['Kategori']=="kel")
          echo "Kelautan";
      else if($data['Kategori']=="sen")
          echo "Seni";
      else if($data['Kategori']=="olr")
          echo "Olahraga";
      else if($data['Kategori']=="sej")
          echo "Sejarah";
      else if($data['Kategori']=="bis")
          echo "Bisnis";
      else if($data['Kategori']=="bio")
          echo "Biografi";
      else if($data['Kategori']=="hib")
          echo "Hiburan";
      else if($data['Kategori']=="lai")
          echo "Lain-lain";  ?> 
          </td>
        </tr>
      </table>
      </div>
            <a href="<?php echo base_url()?>index.php/buku/edit/<?php echo $data['NRP']?>/<?php echo $ID_Buku?>" class="btn btn-primary">Edit Buku</a>
            <a href="<?php echo base_url()?>index.php/buku/hapus/<?php echo $data['NRP']?>/<?php echo $ID_Buku?>" class="btn btn-primary">Hapus Buku</a> 
        </td>
      </table>
		</div>
