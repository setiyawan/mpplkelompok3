    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a href="<?php echo base_url() ?>index.php/profil/beranda/<?php echo $User[0]->NRP?>" class="brand"><img style="max-width:20px; max-height:20px;" src="<?php echo base_url();?>/img/read.png" class="img-rounded"></a>
		...
		<div class="hero-unit">
			<table class="table table-condensed table-hover table-striped">
				...
				foreach ($Buku as $row) {
						...
						echo "</td>	<td> $row->Tahun" ;
						echo "</td>	<td> $row->Penerbit" ;
