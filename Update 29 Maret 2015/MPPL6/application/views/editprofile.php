  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
                ...
                <li><a href="<?php echo base_url()?>index.php/buku/statistik/<?php echo $Mahasiswa[0]->NRP?>">Statistik</a></li>
    ...
    <div class="container">
		<div class="page-header">
			...
			<form class="form-signin" method="post" onSubmit="alert('Thank you for your feedback.');" action="<?php echo base_url()?>index.php/profil/ubah/<?php echo $Mahasiswa[0]->NRP?>" enctype="multipart/form-data">
    <br>
