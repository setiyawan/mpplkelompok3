...
<html lang="en">
  ...
  <body>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li><a href="<?php echo base_url() ?>index.php/login/guest">Beranda</a></li>
              <li><a href="<?php echo base_url()?>index.php/buku/statistik/guest">Statistik</a></li>
              <li class="active"><a href="<?php echo base_url() ?>index.php/sistem/pengaduan/guest">Pengaduan</a></li>
    ...
    <div class="container">
		...
		<div class="hero-unit">
			 <form class="form-search nav"  action="<?php echo base_url()?>index.php/sistem/adu/guest" method="POST">
    			<p>Silahkan tulis keluhan, kritik, atau saran anda pada kolom komentar dibawah ini: <p>
    			<textarea name="text1" class="row-fluid" rows="5" cols="20"></textarea>
    			<p class="text-info"> *Kami menjamin kerahasiaan identitas anda <p>			
    			<p class="text-right"><input class="btn btn-large btn-primary" type="submit" value="Submit"/></a></p>
		  </form>
		 </div>
